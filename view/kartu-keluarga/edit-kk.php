...
// }
   ...
   // move_uploaded_file($tmp_name, "./assets/surat_pengantar/".$nama_gambar = $format.rand(10, 100).".".$ext);
	...
	$update = $objAdmin->updateKK($id_ktp, $nik, $nama, $tgl_lahir, $tempat_lahir, $jekel, $alamat, $telp, $rt, $rw, $desa, $kecamatan, $kabupaten, $agama, $kewar, $pekerjaan,$status_kawin, $tgl_pengambilan);
