...
$pdf->writeHTMLCell(0, 0, '', '', '<center><h2>PEMERINTAH DESA '.$data->desa.'  <br> KETUA RT, '.$data->rt.' RW, '.$data->rw.' <br>Desa '.$data->desa.' Kecamatan '.$data->kec.' Kabupaten '.$data->kab.'<h2></center>', 0, 1, 0, true, 'C', true);
// $pdf->Ln(3);
...
// $pdf->Ln(2);
$pdf->SetX(10);
$pdf->writeHTMLCell(0, 0,10 ,'', '<b><u>SURAT PENGANTAR</u> <br> No.  ..................................</b>' , 0, 1, 0, true, 'C', true);

$pdf->Ln(5);
$pdf->SetX(10);
$pdf->writeHTMLCell(0, 0,10 ,'', 'Yang bersangkutan di bawah ini adalah warga RT, '.$data->rt.' RW, '.$data->rw.' Desa '.$data->desa.'
...
EOD;
  ...
  <tr><td width="200">Status Kawin</td><td width="50">:</td><td> '.$data->status_kawin.' </td></tr>
  ...
  <tr><td width="200">Tanggal Berfoto</td><td width="50">:</td><td> '.$data->tgl_berfoto.' </td></tr>
  ...
  $pdf->Ln(2);
  $pdf->SetX(10);
  $pdf->writeHTMLCell(0, 0,10 ,'', 'Orang tersebut diatas, adalah bener-bener warga RT, '.$data->rt.' RW '.$data->rw.'
  Desa '.$data->desa.' Kecamatan '.$data->kec.' Kabupaten '.$data->kab.' Surat pengantar ini dibuat sebagai kelengkapan pengurusan
  KTP (Kartu Tanda Penduduk).' , 0, 1, 0, true, '', true);
