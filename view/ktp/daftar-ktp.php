...
if (isset($_POST['simpan'])) {
  ...
  $status_kawin       = $_POST['STATUS_KAWIN'];
	...
	$insert = $objAdmin->insertKTP($nik, $nama, $tgl_lahir, $tempat_lahir, $jekel, $alamat, $telp, $rt, $rw, $desa, $kecamatan, $kabupaten, $agama, $kewar, $pekerjaan,$status_kawin);
